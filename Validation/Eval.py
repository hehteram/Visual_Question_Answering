import sys
dataDir = './Dataset'
sys.path.insert(0, '%s/VQA/PythonEvaluationTools' %(dataDir))
sys.path.insert(0, '%s/VQA/PythonHelperTools/vqaTools' %(dataDir))
...
resultType  ='new_real2'
imgDir      ='%s/Images/%s_%s_%s' %(dataDir, dataType, dataSubType, resultType)
